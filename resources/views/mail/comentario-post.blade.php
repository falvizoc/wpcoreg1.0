...
<head>
    ...
    <title>Has recibido un nuevo comentario en tu Blog!</title>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="font-size:15px; color:#455056; margin:12px 0 0; line-height:24px;text-align:left!important;">
                                            {{$comentario->nombre}} ha escrito el siguiente comentario:
                                        </p>
                                        ...
                                        <p style="font-size:13px; color:#455056; margin:12px 0 0; line-height:24px;text-align:left!important;">
                                            En el post <b>{{$post->titulo}}</b>
                                        </p>
                                        ...
                                        <p
                                            ...
                                            <strong
                                                style="display: block;font-size: 13px; margin: 0 0 4px; color:rgba(0,0,0,.64); font-weight:normal;">Nombre del usuario</strong>{{$comentario->nombre}}
                                            <strong
                                                style="display: block; font-size: 13px; margin: 16px 0 4px 0; font-weight:normal; color:rgba(0,0,0,.64);">Email</strong>{{$comentario->email}}
                                        </p>
                                        ...
                                        <p style="font-size:15px; color:#455056; margin:12px 0 0; line-height:24px;text-align:left!important;">
                                            Para ver el comentario, haz clic en el siguiente enlace:
                                        </p>
